...
CREATE TABLE `ca_signer` (
    ...
    `type` varchar(100) NOT NULL COMMENT '签名者类型: PKCS12, JKS, HSM',
...
-- 完成提示
SELECT '所有表结构创建成功！共 16 张表' as '状态';
